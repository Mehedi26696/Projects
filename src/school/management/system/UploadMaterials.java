...
public class UploadMaterials {
    ...
    private void createUploadUI() {
        ...
        fileTypeLabel.setBounds(30, 30, 100, 30);
        ...
        scrollPane.setBounds(30, 250, 430, 100);
        ...
        uploadButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Save to database
                saveToDatabase(fileType, driveLink, description);
                uploadedFilesArea.append(fileType + " Uploaded: " + description + " (" + driveLink + ")\n");
    ...
    private void saveToDatabase(String fileType, String driveLink, String description) {
        try {
            String query = "INSERT INTO materials (file_type, drive_link, description) VALUES (?, ?, ?)";
            Connection c = connect.c;
            PreparedStatement preparedStatement = c.prepareStatement(query);
            preparedStatement.setString(1, fileType);
            preparedStatement.setString(2, driveLink);
